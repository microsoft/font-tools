...
punctuation = ['tcab','tcae','tcbb','tcbe','tcpb','tcpe','tcrb','tcre','tcthb','tcthe','tcbhb','tcbhe']
...
groupdata = {
	...
	'parenstcb0'   : ['parens','tcab0','tcbb0','tcpb0','tcrb0','tcthb0','tcbhb0'],
	'parenstce0'   : ['parens','tcab0','tcbe0','tcpb0','tcrb0','tcthb0','tcbhb0'],
	'parenstcb1'   : ['parens','tcab1','tcbb1','tcpb1','tcrb1','tcthb1','tcbhb1'],
	'parenstce1'   : ['parens','tcae1','tcbe1','tcpe1','tcre1','tcthe1','tcbhe1'],
	...
	'tcb_all'    : ['tcab0','tcab1','tcab2','tcbb0','tcbb1','tcbb2','tcpb0','tcpb1','tcpb2','tcrb0','tcrb1','tcrb2','tcthb0','tcthb1','tcthb2','tcbhb0','tcbhb1','tcbhb2'],
	'tce_all'    : ['tcae0','tcae1','tcae2','tcbe0','tcbe1','tcbe2','tcpe0','tcpe1','tcpe2','tcre0','tcre1','tcre2','tcthe0','tcthe1','tcthe2','tcbhe0','tcbhe1','tcbhe2'],
	'tcbs'        : ['tcab','tcbb','tcpb','tcrb','tcthb','tcbhb'],
	'tces'        : ['tcae','tcbe','tcpe','tcre','tcthe','tcbhe'],
	'tcb0s'        : ['tcab0','tcbb0','tcpb0','tcrb0','tcthb0','tcbhb0'],
	'tcb1s'        : ['tcab1','tcbb1','tcpb1','tcrb1','tcthb1','tcbhb1'],
	'tcb2s'        : ['tcab2','tcbb2','tcpb2','tcrb2','tcthb2','tcbhb2'],
	'tce0s'        : ['tcae0','tcbe0','tcpe0','tcre0','tcthe0','tcbhe0'],
	'tce1s'        : ['tcae1','tcbe1','tcpe1','tcre1','tcthe1','tcbhe1'],
	'tce2s'        : ['tcae2','tcbe2','tcpe2','tcre2','tcthe2','tcbhe2'],
	'tcb01'       : ['tcb1s','tces','tce1s'],
	'tcb02'       : ['tcb2s','tces','tce2s'],
	'tcb12'       : ['tcbs','ss','se','corners','om','ti','mi','bi'],
	'tce12'       : ['tces','ss','se','tcb2s'],
	'tcb_mks'      : [
    'tcab_6','tcab_5','tcab_4','tcab_3','tcab_2','tcab_1',
    'tcbb_6','tcbb_5','tcbb_4','tcbb_3','tcbb_2','tcbb_1',
    'tcpb_6','tcpb_5','tcpb_4','tcpb_3','tcpb_2','tcpb_1',
    'tcrb_6','tcrb_5','tcrb_4','tcrb_3','tcrb_2','tcrb_1',
    'tcthb_6','tcthb_5','tcthb_4','tcthb_3','tcthb_2','tcthb_1',
    'tcbhb_6','tcbhb_5','tcbhb_4','tcbhb_3','tcbhb_2','tcbhb_1'],
	'tce0_mks'    : [
    ...
    'tcthe0_6','tcthe0_5','tcthe0_4','tcthe0_3','tcthe0_2','tcthe0_1',
    'tcbhe0_6','tcbhe0_5','tcbhe0_4','tcbhe0_3','tcbhe0_2','tcbhe0_1'],
	'tce1_mks'    : [
    ...
    'tcthe1_6','tcthe1_5','tcthe1_4','tcthe1_3','tcthe1_2','tcthe1_1',
    'tcbhe1_6','tcbhe1_5','tcbhe1_4','tcbhe1_3','tcbhe1_2','tcbhe1_1'],
	'tce2_mks'    : [
    ...
    'tcthe2_6','tcthe2_5','tcthe2_4','tcthe2_3','tcthe2_2','tcthe2_1',
    'tcbhe2_6','tcbhe2_5','tcbhe2_4','tcbhe2_3','tcbhe2_2','tcbhe2_1'],
	'tce0_mfc'    : ['shapes_0','tce0_mks'],
	'tce1_mfc'    : ['shapes_1','tce1_mks'],
	'tce2_mfc'    : ['shapes_2','tce2_mks'],
